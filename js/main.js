...
$(document).ready(function () {
	...
	$('a[href="/assortiment"]').click(function(e) {
		e.preventDefault();
	});

	$('.pannel-bottom-content nav ul li a[href="/assortiment"]').addClass('to-sub-menu');

	$('.pannel-bottom-content a[href="/assortiment"]').closest('li').hover(
		function () {
			$(this).find('ul').stop().fadeIn(300).css('display', 'flex');
		},
		function () {
			$(this).find('ul').stop().fadeOut(300).css('display', 'flex');
		}
	);
