...
class NestedSetBehavior extends CActiveRecordBehavior
{
	...
	private static $_ignoreEvents=array();
	private function _getHash()
	{
		return get_class($this->getOwner()).$this->owner->{$this->rootAttribute}.$this->owner->{$this->leftAttribute}.$this->owner->{$this->rightAttribute};
	}
	...
	public function save($runValidation=true,$attributes=null)
	{
		...
		self::$_ignoreEvents[$this->_getHash()]=true;
	...
	{
		if($this->_ignoreEvent || isset(self::$_ignoreEvents[$this->_getHash()]))
			return true;
		else
