	...
	<body style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
		<div style="width: 680px;">
			...
			<p style="margin-top: 0px; margin-bottom: 20px;">
				<h1>Новый отзыв с сайта <a href="http://<?php echo \Yii::app()->request->serverName; ?>" target="_blank"><?php \ModuleHelper::getParam('sitename'); ?></a></h1>
			</p>
			...
			<?foreach(['author', 'detail_text'] as $name): ?>
