<?php
/**
 * Основной класс для контроллеров модуля администрирования модуля "Отзывы". 
 *
 */
namespace reviews\modules\admin\components;
...
abstract class BaseController extends \AdminController
{
	 ...
	 */
	public $viewPathPrefix='reviews.modules.admin.views.';
