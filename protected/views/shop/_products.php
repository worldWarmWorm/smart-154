...
<div class="product-item">
	...
	<div class="product<?=HtmlHelper::getMarkCssClass($data, array('sale','new','hit'))?>">
		...
		<div class="product__content">
			<a href="<?= $productUrl ?>" class="into-product">&#10230;</a>
				...
				<?php if($data->price > 0): ?>
					<p class="order__price">
						...
						<?php if($data->old_price > 0): ?>
							<span class="old_price"><?= HtmlHelper::priceFormat($data->old_price); ?>&#8381;</span>
						<?php endif; ?>
						<? endif; ?>
						<span class="new_price"><?= HtmlHelper::priceFormat($data->price); ?>&#8381;</span>
					</p>
				<?php endif; ?>
			</div>
